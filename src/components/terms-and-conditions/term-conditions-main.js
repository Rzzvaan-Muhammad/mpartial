  ...
  return (
    <div className="container static-container my-5 py-4">
      <div className="row">
        ...
        <div>
          <div className="mt-4">
            <p>
              ...
              https://www.shopbizservices.com website (the “Service”) operated
              by Intermediate Marketing Group LLC (“us”, “we”, or “our”).
            </p>
        ...
        <div>
          <h2 className="font-weight-bolder">Intellectual Property</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
              The Service and its original content, features and functionality
              are and will remain the exclusive property of Intermediate
              Marketing Group LLC and its licensors. The Service is protected by
              ...
              written consent of Intermediate Marketing Group LLC.
            </p>
          </div>
        </div>
        <br />
        ...
        <div>
          <h2 className="font-weight-bolder">Links To Other Web Sites</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
              Our Service may contain links to third party web sites or services
              that are not owned or controlled by Intermediate Marketing Group
              LLC
            </p>
            <p>
              Intermediate Marketing Group LLC has no control over, and assumes
            ...
            <p>
              You acknowledge and agree that Intermediate Marketing Group LLC
        ...
        <div>
          <h2 className="font-weight-bolder">Termination</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
        ...
        <div>
          <h2 className="font-weight-bolder">Indemnification</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
              You agree to defend, indemnify and hold harmless Intermediate
              Marketing Group LLC and its licensee and licensors, and their
        ...
        <div>
          <h2 className="font-weight-bolder">Limitation Of Liability</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
              In no event shall Intermediate Marketing Group LLC, nor its
        ...
        <div>
          <h2 className="font-weight-bolder">Disclaimer</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
            ...
            <p>
              Intermediate Marketing Group LLC its subsidiaries, affiliates, and
        ...
        <div>
          <h2 className="font-weight-bolder">Exclusions</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
        ...
        <div>
          <h2 className="font-weight-bolder">Governing Law</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
              These Terms shall be governed and construed in accordance with the
              laws of Arizona, United States, without regard to its conflict of
              law provisions.
            </p>
            <p>
        ...
        <div>
          <h2 className="font-weight-bolder">Changes</h2>
          <div className="underline" />
          <div class="description-list mt-4">
            <p>
